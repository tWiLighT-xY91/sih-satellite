...
PATCH_DIR = REPO / "data/raw/test_patches/patch_02_urban/patch"
...
OUTPUT_DIR = (
    REPO
    / "data/outputs/benchmark/ldsr_s2/patch_02"
)
...
with rasterio.open(PATCH_DIR / "02.tif") as src:
...
output_path = OUTPUT_DIR / "ldsr_s2_patch_02.tif"
...
print("\n🔥 PATCH 02 LDSR-S2 INFERENCE COMPLETE 🔥")